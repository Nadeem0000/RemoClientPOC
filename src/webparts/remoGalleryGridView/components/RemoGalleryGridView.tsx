...
import styles from './RemoGalleryGridView.module.scss';
import { IRemoGalleryGridViewProps } from './IRemoGalleryGridViewProps';
...
export default class RemoGalleryGridView extends React.Component<IRemoGalleryGridViewProps, IRemoGalleryGridViewState, {}> {
  slider2: any; 
  slider1: any;
  public constructor(props: IRemoGalleryGridViewProps, state: IRemoGalleryGridViewState){  
    super(props);      
    this.state = {    
      Images:[],
      Videos:[],           
  ...
  public GetImagesInsideFolder(FolderURL,Mode,key){        
    ...
    if(Mode == "Image"){     
      $("#trigger-image").hide();  
      $("#trigger-video").show();      
      siteurl = "https://remodigital.sharepoint.com/sites/ClientPOC/_api/Web/GetFolderByServerRelativeUrl("+FolderURL+")?$select=ID,Title,FileRef,FileSystemObjectType,FileLeafRef,File/ServerRelativeUrl,File/Name&$expand=Folders,Files";          
    }else if(Mode == "Video"){
      $("#trigger-video").hide();            
      $("#trigger-image").show(); 
      var FolderPath = FolderURL.replace(/[']/g, '');
      var FolderServerRelativeUrl = ""+FolderPath+"/Videos";           
      siteurl = "https://remodigital.sharepoint.com/sites/ClientPOC/_api/Web/GetFolderByServerRelativeUrl('"+FolderServerRelativeUrl+"')?$select=ID,Title,FileRef,FileSystemObjectType,FileLeafRef,File/ServerRelativeUrl,File/Name&$expand=Folders,Files";          
  ...
  public render(): React.ReactElement<IRemoGalleryGridViewProps> {
    var reactHandler = this;
    const settings = {
      dots: false,
      arrows: true,
    ...
    return (
      <div className={ styles.remoGalleryGridView }>
        <section>
