...
import styles from './RemoGalleryVm.module.scss';
import { IRemoGalleryVmProps } from './IRemoGalleryVmProps';
...
let ImgArr = [];
export default class RemoGalleryVm extends React.Component<IRemoGalleryVmProps, IRemoGalleryVmState, {}> {
  slider2: any; 
  slider1: any;
  public lightGallery: any;
  public constructor(props: IRemoGalleryVmProps, state: IRemoGalleryVmState){    
    super(props);      
    this.state = {               
      Galleryitems: [],
      VideoItemsss:[],
  ...
  public render(): React.ReactElement<IRemoGalleryVmProps> {
    const settings = {
      dots: false,
      arrows: true,
      infinite: false,
    ...
    return (
      <div className={ styles.remoGalleryVm }>
        <section>
